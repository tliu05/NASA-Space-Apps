...
# cluster_color_map = {cluster: i for i, cluster in enumerate(unique_clusters)}
...
#         # Only draw edges above threshold or explicitly forced
...
#         base_color = cluster_color_map.get(cluster_id, 0)
